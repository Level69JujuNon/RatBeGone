...
public class CreateConfig {
    ...
    public CreateConfig(String url) {
        this.url = url;
    }

    public CreateConfig setContent(String content) {
        this.content = content;
        return this;
    }

    public CreateConfig setUsername(String username) {
        this.username = username;
        return this;
    }

    public CreateConfig setAvatarUrl(String avatarUrl) {
        this.avatarUrl = avatarUrl;
        return this;
    }

    public CreateConfig setTts(boolean tts) {
        this.tts = tts;
        return this;
    }

    public CreateConfig addEmbed(EmbedObject embed) {
